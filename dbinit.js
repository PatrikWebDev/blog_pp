...
function creation() {
    db.serialize(function () {
        ...
        db.run("CREATE TABLE IF NOT EXISTS drafts ( id VARCHAR(100) NOT NULL, title VARCHAR(100) NOT NULL, content VARCHAR(100) NOT NULL, author VARCHAR(100) NOT NULL, date VARCHAR(100) NOT NULL)")
